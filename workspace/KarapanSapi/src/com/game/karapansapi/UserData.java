...
public class UserData implements OnSharedPreferenceChangeListener {
	...
	public synchronized void inputName(String name)
	{
		mName = name;
		mEditor.putString(NAME_KEY, mName);
		mEditor.commit();
	}
	...
	public synchronized void openAllLevels()
	{
		mUnlockedLevels = 9;
		mEditor.putInt(UNLOCKED_LEVEL_KEY, mUnlockedLevels);
		mEditor.commit();
